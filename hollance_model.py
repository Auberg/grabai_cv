...
TAKEN FROM: https://gist.github.com/hollance/8d30bf5c1622036d16c4f27bd0ec88bf
...
def SEResNet50(include_top=True, weights='imagenet',
    ...
    # x = Reshape([1,1,2048])(GlobalAveragePooling2D()(x))
    x = identity_block(x, 3, [512, 512, 2048], stage=5, block=3)
    x = Reshape([1,1,2048])(GlobalAveragePooling2D(name='added_gap')(x))
